  ...
  const emailData = [
    {
      ...
      to,
      subject: 'Welcome to NectarEDU!',
      content: `
    <p>Dear ${name},</p>
      <p>My name is Best, the founder of NectarEDU. I saw you signed up, any questions so far?</p>
      <p>
      ...
      <div>
        <a href="https://NectarEDU.com/demo">Book demo</a>
      </div>
      <p>
