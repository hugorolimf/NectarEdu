<script lang="ts">
  ...
  $: lessonSections = courseData ? getLessonSections(courseData) : [];
  $: totalLessons = getTotalLessons(lessonSections);
      ...
      {:else}
        <div class="banner-image relative overflow-hidden rounded-md md:w-2/3">
          <img
            ...
            alt="About us"
            src={bannerImage ? bannerImage : '/images/NectarEDU-course-img-template.jpg'}
