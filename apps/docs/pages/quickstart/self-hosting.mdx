...
import SelfhostNectarEDU from './images/selfhost-NectarEDU.webp';

# Self-hosting NectarEDU.com

This guide will help you quickly selfhost NectarEDU

<Image src={SelfhostNectarEDU} alt="Selfhost NectarEDU" quality="100" />

NectarEDU is made up of the following applications

- [apps/api](https://github.com/rotimi-best/NectarEDU/tree/main/apps/api) - an Express server
- [apps/dashboard](https://github.com/rotimi-best/NectarEDU/tree/main/apps/dashboard) - the admin dashboard + LMS
- [supabase](https://github.com/rotimi-best/NectarEDU/tree/main/supabase) - the database + REST API.
...
We have a standalone guide to help you setup your Supabase Cloud and you can find it [here](https://NectarEDU.com/docs/contributor-guides/supabase-cloud)
...
<Callout type="info" emoji="ℹ️">
  ...
  [here](https://github.com/rotimi-best/NectarEDU/blob/main/apps/api/.env.example)
</Callout>
...
<Callout type="info" emoji="ℹ️">
  Learn more about the environment variables
  [here](https://github.com/rotimi-best/NectarEDU/blob/main/apps/dashboard/.env.example)
</Callout>
