...
import NectarEDUBasePage from './images/NectarEDU.webp';
...
Go to [app.NectarEDU.com](https://app.NectarEDU.com). Click on the "Login"" button on the top right to take you to the Login page.

<Image src={NectarEDUBasePage} alt="NectarEDU Page" quality="100" />

### Sign In

Sign in with your email & password.

<Image src={signUpPage} alt="NectarEDU Page" quality="100" />
