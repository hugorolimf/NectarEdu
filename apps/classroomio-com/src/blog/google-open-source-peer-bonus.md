...
imageUrl: 'https://assets.cdn.clsrio.com/blog/google-os-peer-bonus-NectarEDU.png'
date: '2024-05-25'
author: Rotimi Best
...
![best](/blog/google-os-peer-bonus-NectarEDU.png)
...
After I made [NectarEDU](https://git.new/class) open source, a lot of people helped us get traction from the community and soon enough we got noticed by several educators in the community.
...
I want to use this opportunity to thank [Ada Nduka Oyom](https://x.com/Kolokodess) for reaching out to me and recommending [NectarEDU](https://git.new/class) internally at Google to receive the Google Open Source Peer Bonus.

I received the award letter this week and the official blog post will be made on their website in the coming weeks.

![bonus-letter](/blog/os-peer-bonus-award-letter-NectarEDU.jpg)
