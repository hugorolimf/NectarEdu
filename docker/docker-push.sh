...
# Docker Hub Push Script for NectarEDU
# This script builds and pushes the API and Dashboard images to Docker Hub

set -e  # Exit on error

# Configuration
DOCKERHUB_USERNAME="${DOCKERHUB_USERNAME:-NectarEDU}"  # Change this to your Docker Hub username
...
echo -e "${BLUE}================================${NC}"
echo -e "${BLUE}NectarEDU Docker Hub Publisher${NC}"
echo -e "${BLUE}================================${NC}"
echo ""
